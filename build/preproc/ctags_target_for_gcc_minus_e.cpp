# 1 "/Users/igor/Documents/Arduino/DIGI1/src/DIGI1/DIGI1.ino"
/********************************************************************************
...
# 14 "/Users/igor/Documents/Arduino/DIGI1/src/DIGI1/DIGI1.ino" 2
# 15 "/Users/igor/Documents/Arduino/DIGI1/src/DIGI1/DIGI1.ino" 2
// #include <uMQTTBroker.h>
# 17 "/Users/igor/Documents/Arduino/DIGI1/src/DIGI1/DIGI1.ino" 2
// #include <Hash.h>
# 19 "/Users/igor/Documents/Arduino/DIGI1/src/DIGI1/DIGI1.ino" 2
# 20 "/Users/igor/Documents/Arduino/DIGI1/src/DIGI1/DIGI1.ino" 2
# 21 "/Users/igor/Documents/Arduino/DIGI1/src/DIGI1/DIGI1.ino" 2
LiquidCrystal_I2C lcd(0x27, 20, 4); // call to lcd has to be before including bigFontChars
# 23 "/Users/igor/Documents/Arduino/DIGI1/src/DIGI1/DIGI1.ino" 2
# 24 "/Users/igor/Documents/Arduino/DIGI1/src/DIGI1/DIGI1.ino" 2
...
void setup()
{
  ...
  pinMode(PDN, 0x01); // ak4490 PDN pin.
  digitalWrite(PDN, 0x0); // Keep PDN pin low.
  pinMode(DSDPIN, 0x00); // DSD detection pin.
  ...
  if (volMode == false)
  {
    if (rot == 1)
    {
      if (muted)
      {
        ...
        tempVolume = ((tempVolume)<(0)?(0):((tempVolume)>(255)?(255):(tempVolume)));
        printVol();
      }
      else
      {
        mainVolume = mainVolume + 5;
        mainVolume = ((mainVolume)<(0)?(0):((mainVolume)>(255)?(255):(mainVolume)));
        SetVol(mainVolume);
      }
    }
...
void SetDSD()
{
  ...
  temp = 0;
  WriteRegister(ak4490, 0x00, 0); // Reset
  WriteRegister(ak4490, 0x00, 143); // Set To Master Clock Frequency Auto / 24Bit I2S Mode
  WriteRegister(ak4490, 0x06, 153); // Set To DSD Data Mute / DSD Mute Control / DSD Mute Release
  WriteRegister(ak4490, 0x09, 1); // Set To DSD Sampling Speed Control
}
...
void SetPCM()
{
  ...
  temp_1 = 0;
  WriteRegister(ak4490_1, 0x00, 0);
  WriteRegister(ak4490_1, 0x00, 143);
...
void SetSpeed(byte x)
{
  if (x == 0)
  {
    WriteRegister(ak4490, 0x01, 2);
    WriteRegister(ak4490_1, 0x01, 2);
    WriteRegister(ak4490, 0x07, 0);
    WriteRegister(ak4490_1, 0x07, 0);
    WriteRegister(ak4490, 0x00, 0);
    WriteRegister(ak4490, 0x00, 135);
    WriteRegister(ak4490_1, 0x00, 0);
    WriteRegister(ak4490_1, 0x00, 135);
  }
  else if (x == 1)
  {
    WriteRegister(ak4490, 0x01, 10);
    WriteRegister(ak4490_1, 0x01, 10);
    WriteRegister(ak4490, 0x07, 1);
    WriteRegister(ak4490_1, 0x07, 1);
    WriteRegister(ak4490, 0x00, 0);
    WriteRegister(ak4490, 0x00, 135);
    WriteRegister(ak4490_1, 0x00, 0);
    WriteRegister(ak4490_1, 0x00, 135);
...
void SetBits(byte bitDepth)
{
  if (bitDepth == 0)
  {
    ...
    WriteRegister(ak4490_1, 0x00, 0);
    WriteRegister(ak4490, 0x00, 135);
    WriteRegister(ak4490_1, 0x00, 135); // 24bit I2S
  }
  else if (bitDepth == 1)
  {
    WriteRegister(ak4490, 0x00, 0);
    WriteRegister(ak4490_1, 0x00, 0);
    WriteRegister(ak4490, 0x00, 143);
    WriteRegister(ak4490_1, 0x00, 143); // 32bit I2S
  }
  else if (bitDepth == 2)
  {
    WriteRegister(ak4490, 0x00, 0);
    WriteRegister(ak4490_1, 0x00, 0);
    WriteRegister(ak4490, 0x00, 133);
    WriteRegister(ak4490_1, 0x00, 133); // 24bit MSB
  }
  else if (bitDepth == 3)
  {
    WriteRegister(ak4490, 0x00, 0);
    WriteRegister(ak4490_1, 0x00, 0);
    WriteRegister(ak4490, 0x00, 137);
    WriteRegister(ak4490_1, 0x00, 137); // 24bit LSB
  }
  else if (bitDepth == 4)
  {
    WriteRegister(ak4490, 0x00, 0);
    WriteRegister(ak4490_1, 0x00, 0);
    WriteRegister(ak4490, 0x00, 129);
    WriteRegister(ak4490_1, 0x00, 139); // 32bit LSB
  }
  else if (bitDepth == 5)
  {
    WriteRegister(ak4490, 0x00, 0);
    WriteRegister(ak4490_1, 0x00, 0);
    WriteRegister(ak4490, 0x00, 141);
    WriteRegister(ak4490_1, 0x00, 141); // 32bit MSB
  }
  else if (bitDepth == 6)
  {
    WriteRegister(ak4490, 0x00, 0);
    WriteRegister(ak4490_1, 0x00, 0);
    WriteRegister(ak4490, 0x00, 129);
    WriteRegister(ak4490_1, 0x00, 129); // 16bit LSB
  }
}
...
void SetSoundMode(int soundcontrol)
{
  ...
  case 1:
    ...
    WriteRegister(ak4490, 0x08, 0);
    break;

  case 2:
    Serial.println("Sound Setting 2");
    WriteRegister(ak4490, 0x08, 1);
    break;

  case 3:
    Serial.println("Sound Setting 3");
    WriteRegister(ak4490, 0x08, 2);
    break;
  }
  //PrintDebugReg();
}
...
void DeviceInit(byte devaddr) // resets and initializes the DAC
{
  ...
  digitalWrite(PDN, 0x0); // Reset the DAC
  delay(1);
  digitalWrite(PDN, 0x1); // Power up the DAC
  WriteRegister(devaddr, 0x00, 133); // Initialize the DAC. Sets Auto MCLK & SF, I2S 32bit and RSTN=1
